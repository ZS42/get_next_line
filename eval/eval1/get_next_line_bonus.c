...
/*   Updated: 2022/07/05 15:51:49 by zsyyida          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//making static char an array makes it possible to access various fds as called
char	*get_next_line(int fd)
{
	...
	while (bytes > 0)
	{
		...
		buff[bytes] = '\0';
		storage[fd] = ft_strnjoin(storage[fd], buff, bytes);
